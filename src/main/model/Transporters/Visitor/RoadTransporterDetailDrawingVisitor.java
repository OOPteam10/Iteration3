 ...
 */
public class RoadTransporterDetailDrawingVisitor implements RoadTransporterVisitor{
    ...
    public RoadTransporterDetailDrawingVisitor(AssetManager assets, GraphicsContext gc, Camera camera, Sector sector){
        this.assets = assets;
        this.gc = gc;
        this.camera = camera;
        this.sector = sector;
