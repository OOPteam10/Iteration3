...
import model.Abilities.buildAbilities.BuildSawmillAbility;
 ...
 */
public class BuildSawmillAbilityVisitor extends LandProducerBuildAbilityVisitor {
    private ArrayList<Board> boardArrayList = new ArrayList<>();
    private ArrayList<Stone> stoneArrayList = new ArrayList<>();
    private BuildSawmillAbility buildSawmillAbility;
    ...
    public void consume() {
        if (boardArrayList.size() >= 2 && stoneArrayList.size() >= 1) {
            buildSawmillAbility = new BuildSawmillAbility(
