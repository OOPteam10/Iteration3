 ...
 */
public class BuildIronSpecializedMineAbilityVisitor extends LandProducerBuildAbilityVisitor {
    private ArrayList<Board> boardArrayList = new ArrayList<>();
    private ArrayList<Stone> stoneArrayList = new ArrayList<>();
    private BuildIronSpecializedMineAbility buildSpecialtyMineBuildAbility;
    ...
    public void consume() {
        if (boardArrayList.size() >= 3 && stoneArrayList.size() >= 1) {
            buildSpecialtyMineBuildAbility = new BuildIronSpecializedMineAbility(
